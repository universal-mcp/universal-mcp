...
def generate_docstring(function_code: str, model: str = "anthropic/claude-3-sonnet-20240229") -> DocstringOutput:
    """
...
def process_file(file_path: str, model: str = "anthropic/claude-3-sonnet-20240229") -> int:
    """
