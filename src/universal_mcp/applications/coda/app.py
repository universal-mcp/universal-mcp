...
class CodaApp(APIApplication):
    ...
    def list_docs(self, isOwner=None, isPublished=None, query=None, sourceDoc=None, isStarred=None, inGallery=None, workspaceId=None, folderId=None, limit=None, pageToken=None) -> dict[str, Any]:
        """
    ...
    def create_doc(self, title=None, sourceDoc=None, timezone=None, folderId=None, initialPage=None) -> dict[str, Any]:
        """
    ...
    def add_permission(self, docId, access, principal, suppressEmail=None) -> dict[str, Any]:
        """
    ...
    def update_acl_settings(self, docId, allowEditorsToChangePermissions=None, allowCopying=None, allowViewersToRequestEditing=None) -> dict[str, Any]:
        """
    ...
    def publish_doc(self, docId, slug=None, discoverable=None, earnCredit=None, categoryNames=None, mode=None) -> dict[str, Any]:
        """
    ...
    def create_page(self, docId, name=None, subtitle=None, iconName=None, imageUrl=None, parentPageId=None, pageContent=None) -> dict[str, Any]:
        """
    ...
    def update_page(self, docId, pageIdOrName, name=None, subtitle=None, iconName=None, imageUrl=None, isHidden=None, contentUpdate=None) -> dict[str, Any]:
        """
    ...
    def begin_page_content_export(self, docId, pageIdOrName, outputFormat) -> dict[str, Any]:
        """
    ...
    def get_page_content_export_status(self, docId, pageIdOrName, requestId) -> dict[str, Any]:
        """
    ...
    def list_tables(self, docId, limit=None, pageToken=None, sortBy=None, tableTypes=None) -> dict[str, Any]:
        """
    ...
    def get_table(self, docId, tableIdOrName, useUpdatedTableLayouts=None) -> dict[str, Any]:
        """
    ...
    def list_columns(self, docId, tableIdOrName, limit=None, pageToken=None, visibleOnly=None) -> dict[str, Any]:
        """
    ...
    def list_rows(self, docId, tableIdOrName, query=None, sortBy=None, useColumnNames=None, valueFormat=None, visibleOnly=None, limit=None, pageToken=None, syncToken=None) -> dict[str, Any]:
        """
    ...
    def upsert_rows(self, docId, tableIdOrName, rows, disableParsing=None, keyColumns=None) -> dict[str, Any]:
        """
    ...
    def get_row(self, docId, tableIdOrName, rowIdOrName, useColumnNames=None, valueFormat=None) -> dict[str, Any]:
        """
    ...
    def update_row(self, docId, tableIdOrName, rowIdOrName, row, disableParsing=None) -> dict[str, Any]:
        """
    ...
    def push_button(self, docId, tableIdOrName, rowIdOrName, columnIdOrName) -> dict[str, Any]:
        """
    ...
    def list_formulas(self, docId, limit=None, pageToken=None, sortBy=None) -> dict[str, Any]:
        """
    ...
    def list_controls(self, docId, limit=None, pageToken=None, sortBy=None) -> dict[str, Any]:
        """
    ...
    def trigger_webhook_automation(self, docId, ruleId, request_body=None) -> dict[str, Any]:
        """
    ...
    def list_page_analytics(self, docId, sinceDate=None, untilDate=None, pageToken=None, limit=None) -> dict[str, Any]:
        """
    ...
    def list_doc_analytics_summary(self, isPublished=None, sinceDate=None, untilDate=None, workspaceId=None) -> dict[str, Any]:
        """
    ...
    def list_pack_analytics(self, packIds=None, workspaceId=None, query=None, sinceDate=None, untilDate=None, scale=None, pageToken=None, orderBy=None, direction=None, isPublished=None, limit=None) -> dict[str, Any]:
        """
    ...
    def list_pack_analytics_summary(self, packIds=None, workspaceId=None, isPublished=None, sinceDate=None, untilDate=None) -> dict[str, Any]:
        """
    ...
    def list_pack_formula_analytics(self, packId, packFormulaNames=None, packFormulaTypes=None, sinceDate=None, untilDate=None, scale=None, pageToken=None, orderBy=None, direction=None, limit=None) -> dict[str, Any]:
        """
    ...
    def get_analytics_last_updated(self, ) -> dict[str, Any]:
        """
    ...
    def list_workspace_members(self, workspaceId, includedRoles=None, pageToken=None) -> dict[str, Any]:
        """
    ...
    def list_packs(self, accessType=None, accessTypes=None, sortBy=None, limit=None, direction=None, pageToken=None, onlyWorkspaceId=None, parentWorkspaceIds=None, excludePublicPacks=None, excludeIndividualAcls=None, excludeWorkspaceAcls=None, includeBrainOnlyPacks=None) -> dict[str, Any]:
        """
    ...
    def create_pack(self, workspaceId=None, name=None, description=None, sourcePackId=None) -> dict[str, Any]:
        """
    ...
    def update_pack(self, packId, overallRateLimit=None, perConnectionRateLimit=None, logoAssetId=None, coverAssetId=None, exampleImages=None, sourceCodeVisibility=None, name=None, description=None, shortDescription=None, supportEmail=None, termsOfServiceUrl=None, privacyPolicyUrl=None) -> dict[str, Any]:
        """
    ...
    def get_next_pack_version(self, packId, proposedMetadata, sdkVersion=None) -> dict[str, Any]:
        """
    ...
    def get_pack_version_diffs(self, packId, basePackVersion, targetPackVersion) -> dict[str, Any]:
        """
    ...
    def pack_version_upload_complete(self, packId, packVersion, notes=None, source=None, allowOlderSdkVersion=None) -> dict[str, Any]:
        """
    ...
    def create_pack_release(self, packId, packVersion, releaseNotes=None) -> dict[str, Any]:
        """
    ...
    def update_pack_release(self, packId, packReleaseId, releaseNotes=None) -> dict[str, Any]:
        """
    ...
    def set_pack_oauth_config(self, packId, clientId=None, clientSecret=None, redirectUri=None) -> dict[str, Any]:
        """
    ...
    def upload_pack_asset(self, packId, packAssetType, imageHash, mimeType, filename) -> dict[str, Any]:
        """
    ...
    def upload_pack_source_code(self, packId, payloadHash, filename, packVersion=None) -> dict[str, Any]:
        """
    ...
    def pack_asset_upload_complete(self, packId, packAssetId, packAssetType) -> dict[str, Any]:
        """
    ...
    def pack_source_code_upload_complete(self, packId, packVersion, filename, codeHash) -> dict[str, Any]:
        """
    ...
    def get_pack_listing(self, packId, workspaceId=None, docId=None, installContext=None, releaseChannel=None) -> dict[str, Any]:
        """
    ...
    def list_pack_logs(self, packId, docId, limit=None, pageToken=None, logTypes=None, beforeTimestamp=None, afterTimestamp=None, order=None, q=None, requestIds=None) -> dict[str, Any]:
        """
    ...
    def list_ingestion_logs(self, packId, organizationId, rootIngestionId, limit=None, pageToken=None, logTypes=None, ingestionExecutionId=None, beforeTimestamp=None, afterTimestamp=None, order=None, q=None, requestIds=None) -> dict[str, Any]:
        """
    ...
    def list_grouped_pack_logs(self, packId, docId, limit=None, pageToken=None, beforeTimestamp=None, afterTimestamp=None, order=None, q=None) -> dict[str, Any]:
        """
    ...
    def list_grouped_ingestion_logs(self, packId, organizationId, rootIngestionId, limit=None, pageToken=None, ingestionExecutionId=None, beforeTimestamp=None, afterTimestamp=None, order=None, q=None) -> dict[str, Any]:
        """
    ...
    def list_ingestion_executions(self, packId, organizationId, rootIngestionId, limit=None, pageToken=None, beforeTimestamp=None, afterTimestamp=None, order=None, ingestionStatus=None, datasource=None, executionType=None, includeDeletedIngestions=None, csbIngestionId=None, csbIngestionExecutionId=None) -> dict[str, Any]:
        """
    ...
    def list_ingestion_execution_attempts(self, packId, organizationId, rootIngestionId, ingestionExecutionId, limit=None, pageToken=None, order=None) -> dict[str, Any]:
        """
    ...
    def get_pack_log_details(self, packId, organizationId, rootIngestionId, logId, detailsKey) -> dict[str, Any]:
        """
    ...
    def add_go_link(self, organizationId, name, destinationUrl, description=None, urlPattern=None, creatorEmail=None) -> dict[str, Any]:
        """
