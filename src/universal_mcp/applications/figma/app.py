...
class FigmaApp(APIApplication):
    ...
    def get_file(self, file_key, version=None, ids=None, depth=None, geometry=None, plugin_data=None, branch_data=None) -> Any:
        """
    ...
    def get_file_nodes(self, file_key, ids, version=None, depth=None, geometry=None, plugin_data=None) -> Any:
        """
    ...
    def get_images(self, file_key, ids, version=None, scale=None, format=None, svg_outline_text=None, svg_include_id=None, svg_include_node_id=None, svg_simplify_stroke=None, contents_only=None, use_absolute_bounds=None) -> Any:
        """
    ...
    def get_file_versions(self, file_key, page_size=None, before=None, after=None) -> Any:
        """
    ...
    def get_team_components(self, team_id, page_size=None, after=None, before=None) -> Any:
        """
    ...
    def get_team_component_sets(self, team_id, page_size=None, after=None, before=None) -> Any:
        """
    ...
    def post_webhook(self, event_type, team_id, endpoint, passcode, status=None, description=None) -> Any:
        """
    ...
    def put_webhook(self, webhook_id, event_type, endpoint, passcode, status=None, description=None) -> Any:
        """
    ...
    def get_activity_logs(self, events=None, start_time=None, end_time=None, limit=None, order=None) -> Any:
        """
    ...
    def get_payments(self, plugin_payment_token=None, user_id=None, community_file_id=None, plugin_id=None, widget_id=None) -> Any:
        """
    ...
    def post_variables(self, file_key, variableCollections=None, variableModes=None, variables=None, variableModeValues=None) -> Any:
        """
