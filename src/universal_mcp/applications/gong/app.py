...
class GongApp(APIApplication):
    ...
    def list_calls(self, fromDateTime, toDateTime, cursor=None, workspaceId=None) -> dict[str, Any]:
        """
    ...
    def list_calls_extensive(self, filter, cursor=None, contentSelector=None) -> dict[str, Any]:
        """
    ...
    def create_permission_profile(self, workspaceId, id=None, name=None, description=None, callsAccess=None, libraryFolderAccess=None, dealsAccess=None, forecastPermissions=None, coachingAccess=None, insightsAccess=None, usageAccess=None, emailsAccess=None, scoreCalls=None, overrideScore=None, downloadCallMedia=None, shareCallsWithCustomers=None, manuallyScheduleAndUploadCalls=None, privateCalls=None, deleteCalls=None, trimCalls=None, listenInCalls=None, deleteEmails=None, callsAndSearch=None, library=None, deals=None, createEditAndDeleteDealsBoards=None, dealsInlineEditing=None, account=None, coaching=None, usage=None, teamStats=None, initiatives=None, market=None, activity=None, forecast=None, forecastManage=None, engageManageCompanyTemplates=None, engageManageCompanySequences=None, engageCreateAndManageRulesets=None, engageSnoozeFlowToDosForOthers=None, viewEngageAnalyticsActivity=None, viewEngageAnalyticsPerformance=None, viewEngageAnalyticsFlows=None, manageGeneralBusinessSettings=None, manageScorecards=None, exportCallsAndCoachingDataToCSV=None, crmDataInlineEditing=None, crmDataImport=None, viewRevenueAnalytics=None, manageRevenueAnalytics=None) -> dict[str, Any]:
        """
    ...
    def update_meeting(self, meetingId, startTime, endTime, invitees, organizerEmail, title=None, externalId=None) -> dict[str, Any]:
        """
    ...
    def content_viewed(self, reportingSystem, eventTimestamp, contentId, contentUrl, contentTitle, eventId=None, viewActionTitle=None, shareId=None, viewInfoUrl=None, viewer=None, crmContext=None, contentProperties=None, eventProperties=None, userAgent=None, mobileAppId=None, agentPlatform=None, workspaceId=None, trackingId=None, nonCompanyParticipants=None, moreInfoUrl=None, actionName=None, sharer=None, sharingMessageSubject=None, sharingMessageBody=None) -> Any:
        """
    ...
    def list_generic_crm_integration(self, ) -> dict[str, Any]:
        """
    ...
    def delete_generic_crm_integration(self, integrationId, clientRequestId) -> dict[str, Any]:
        """
    ...
    def list_multiple_users_day_by_day_activity(self, filter, cursor=None) -> dict[str, Any]:
        """
    ...
    def list_multiple_users_aggregate_activity(self, filter, cursor=None) -> dict[str, Any]:
        """
    ...
    def list_multiple_users_aggregate_by_period(self, filter, aggregationPeriod, cursor=None) -> dict[str, Any]:
        """
    ...
    def add_meeting(self, startTime, endTime, invitees, organizerEmail, title=None, externalId=None) -> dict[str, Any]:
        """
    ...
    def assign_prospects(self, crmProspectsIds, flowId, flowInstanceOwnerEmail) -> dict[str, Any]:
        """
    ...
    def add_digital_interaction(self, eventId, timestamp, eventType, content, sourceSystemName=None, sessionId=None, device=None, person=None, customFields=None, trackingId=None) -> dict[str, Any]:
        """
    ...
    def upload_crm_schema_field(self, integrationId, objectType, items) -> dict[str, Any]:
        """
    ...
    def get_crm_objects(self, integrationId, objectType, objectsCrmIds) -> dict[str, Any]:
        """
    ...
    def list_logs(self, logType, fromDateTime, toDateTime=None, cursor=None) -> dict[str, Any]:
        """
    ...
    def list_flows(self, flowOwnerEmail, cursor=None, workspaceId=None) -> dict[str, Any]:
        """
    ...
    def list_crmcalls_manual_association(self, fromDateTime=None, cursor=None) -> dict[str, Any]:
        """
