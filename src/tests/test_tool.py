...
def test_parse_docstring_summary_and_returns():
    ...
    expected = {
        "summary": "Calculates the sum.", "args": {},
        "returns": "The sum of a and b.", "raises": {}, "tags": [],
    }
    assert parse_docstring(docstring) == expected
...
def test_parse_docstring_summary_and_raises():
    ...
    expected = {
        "summary": "Divides two numbers.", "args": {}, "returns": "",
        "raises": {"ZeroDivisionError": "If the denominator is zero."}, "tags": [],
    }
    assert parse_docstring(docstring) == expected
...
def test_parse_docstring_summary_and_tags():
    ...
    expected = {
        "summary": "Processes data.", "args": {}, "returns": "", "raises": {},
...
def test_parse_docstring_returns_multi_line():
    ...
    """
    expected = {
        "summary": "Fetches detailed information.", "args": {},
...
def test_parse_docstring_raises_multi_line():
    ...
    """
    expected = {
        "summary": "Performs a critical action.", "args": {}, "returns": "",
        "raises": {
...
def test_parse_docstring_no_summary():
    ...
    expected = {
        ...
        "returns": "Processed data.", "raises": {}, "tags": [],
    }
    assert parse_docstring(docstring) == expected
...
def test_parse_docstring_with_mixed_type_str_and_none():
    ...
    expected = {
        ...
        "args": {
            ...
            "strict_mode": {"description": "Enable strict mode. (No type in docstring)", "type_str": None}, # Corrected description
...
def test_tool_from_function_with_docstring_types():
    ...
    assert tool_instance.args_description == { 
