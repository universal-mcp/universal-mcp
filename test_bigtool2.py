...
async def target_function1(inputs: dict):
    ...
    result = await agent.ainvoke(inputs, config = {"recursion_limit": 15}, context={ "model": "anthropic/claude-4-sonnet-20250514"})
    return result
...
async def target_function3(inputs: dict):
    ...
    result = await agent.ainvoke(inputs, config = {"recursion_limit": 35}, context={ "model": "anthropic/claude-4-sonnet-20250514"})
    return result
